...
public class Program
{
    ...
    //    Intrest iUpdate = IntrestDB.SelectById(139);
    //    iUpdate.Name = "update";
    //    idb.Update(iUpdate);
    //    y = idb.SaveChanges();
    //    Console.WriteLine($"{y} rows were updated");
    ...
    //    //sdInsert.IdSeries = Book_SeriesDB.SelectById(130);
    ...
    //    Series_Detail sdUpdate = Series_DetailDB.SelectById(102);
    //    sdUpdate.IdSeries = Book_SeriesDB.SelectById(130);
    ...
    //    //Series_Detail sdDelete = Series_DetailDB.SelectById(101);
    ...
    public static async Task Main(string[] args)
    {
        ...
        //    updateR.PremiumSubscription = true;
        ...
        //    };
        //    await buyerService.InsertBookList(insertBL);
        ...
        //        IdBook = book.First()
        //    };
        //    await buyerService.InsertListDetail(insertLD);
