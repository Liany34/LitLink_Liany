...
namespace ViewModel
{
    public class AuthorDB : UserDB
    {
        ...
        {
            command.CommandText = $"SELECT [User].id, [User].firstName, [User].lastName, [User].phoneNumber, [User].email, [User].username, [User].pass, [User].birthdate, [User].picture, Author.penName, Author.genre, Author.informationAboutAuthor " +
